...
pub type CryptoResult = Result<String, error::Error>;

pub fn encipher(plain_text: &str, key: &str) -> CryptoResult {
...
pub fn decipher(cipher_text: &str, key: &str) -> CryptoResult {
    let keyb = key.as_bytes();
